...
# to_con = sqlalchemy.create_engine("mysql+pymysql://root:123456@localhost:3306/edu_design?charset=utf8")
# cur = con.cursor()
...
# cur = con.cursor()
# cur.executemany(
#     "insert into scenery_web (`scenery_name` ,`scenery_detail`,`mark` ,`rank` ,`scenery_address`,`scenery_way` ,`scenery_open`, `scenery_menpiao`,`scenery_other`) values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",
#     df.values.tolist())
# con.commit()
# print(1)
